...
class LoginComponent extends Component {
    ...
    sendResetLink(values) {
        ...
        console.log("reset link api called")

            fetch(`http://appnivi.tech:8110/user/forgotPassword?userEmail=${values.email}`, {
                method: "GET",
                headers: { 'Content-Type': 'application/json' }
            })
                .then((response) => response.json())
                .then((response) => {
                    ...
                    if (response["error"] == false) {
                        console.log("done")
                        message.success("Reset Password link has been sent to your email. Please Check!")
                    }
                    else {
                        message.error("Couldn't send reset link")
                    }
                })
                .catch((err) => {
                    console.log(err);
                                                ...
                                                <div id="PhoneAndNameForm">
                                                    ...
                                                    <div className="RegisterFormDivision">
                                                        ...
                                                        <Form.Item label="Password">
                                                            ...
                                                            <span onClick={this.showForgetPassword}>Forgot Password</span>
                                                        </Form.Item>
                                                    </div>
