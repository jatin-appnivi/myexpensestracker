      ...
      <Router>
        <Layout>
          ...
          <Layout className="site-layout">
            ...
            >
              <Switch>
                <Route path="/home/dashboard" exact component={HomeComponent}></Route>
                <Route path="/home/allsheets" exact component={AllSheetComponent}></Route>
                <Route path="/home/monthly" exact component={SingleSheetComponent}></Route>
                <Route path="/home/settings" exact component={SettingsComponent}></Route>
              </Switch>
            </Content>
          </Layout>
        </Layout>
